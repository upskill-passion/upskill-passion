    ...
    <main className="flex flex-col w-full">
      <article className="flex sm:px-4 sm:py-6 p-4 lg:flex-row flex-col items-center sm:justify-around justify-center bg-[#96B9FD]">
        <div className="text-white">
          ...
          <p className="font-semibold text-[24px] leading-[32px] tracking-tight my-4 max-w-[700px]">
            A Website to help students acquire knowledge and relevant industry
            skills in their field of interest, and practice them in real
            environments
          </p>
          <button
            type="button"
        ...
        <div className="flex flex-row justify-around items-center gap-4 ">
          <div className="text-left max-w-[600px]">
            ...
            <p className="text-[22px] leading-[32px] tracking-tight">
              ...
              languages.Students can register through the website or by phone
              call.Teachers can register and create tutorials and host them on
              youtube in local languages.Students can search for the skills they
              want to learn.
            </p>
          </div>
        ...
        <div className="flex flex-row justify-around items-center gap-4 ">
          ...
          <div className="text-left max-w-[600px]">
            ...
            <p className="text-[22px] leading-[32px] tracking-tight">
              ...
              overcome/fulfilled.To create an easy platform to easily address
              the problems and get people ready to help
            </p>
          </div>
        </div>
      </article>
      <article className="bg-[#717FFF] py-16">
        ...
        <p className="text-center text-white sm:text-[22px] text-[16px] max-w-[375px] sm:max-w-[700px] lg:max-w-[900px] mx-auto my-4">
          All types of jobs are listed, based on your profile jobs/professions
          woth resources will be displayed to you, you can only search for
          something of you know about ot first, so using the profession
          recommendation you can search for it's related information, blogs,
          resources, no doubt you will have queries that's why we built query
          architecture for you to search for your question if already not
          available, post your questions, if you are capable reply to questions
          raised by others, upvote, downvote replies and since we gave you
          resources for a profession, we also built a job architecture for you
          to search for companies who provides jobs in these roles and give you
          opportunities to apply for the job.
        </p>
      </article>
    </main>
  );
